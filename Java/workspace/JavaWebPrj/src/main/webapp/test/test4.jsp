...
<body>
	<div id="container">
		...
		<section id="main">
			<nav class="m-menu">
				<ul>
					<li><a><img src="images/nav1.jpg"></a>
					<a><img src="images/nav1_over.jpg"></a></li>
					<li><a><img src="images/nav2.jpg"></a>
					<a><img src="images/nav2_over.jpg"></a></li>
					<li><a><img src="images/nav3.jpg"></a>
					<a><img src="images/nav3_over.jpg"></a></li>
					<li><a><img src="images/nav4.jpg"></a>
					<a><img src="images/nav4_over.jpg"></a></li>
				</ul>
			</nav>
